...
var id=document.getElementById('scroll-down')
var bookid = document.getElementById('book-variety')
var smallbooks=document.getElementsByClassName('book-container')
$('#scroll-down').on('click',function(){
  var x = bookid.scrollTop;
	bookid.scrollTop = x + 80
...
function showresult(){
  document.getElementById('myresult').style.display="inline"
